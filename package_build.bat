...
conan create . --name=stdx --user=yrezaei --channel=development --build=missing -s compiler.cppstd=17 -s build_type=%BUILD_TYPE% -o stdx/*:shared=%SHARED_FLAG% -o stdx/*:local_dev=True
if errorlevel 1 (
